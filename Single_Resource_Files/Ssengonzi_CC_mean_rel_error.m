% Mean relative error error (mre) calculations, all clusters
...
%Below is relative error in decimal form
%NE_1_aae = mean(abs((NE_1_mat - NE_cred_mat)./NE_cred_mat))%


for d = 1
% ----- NE Mean relative error calculations ---

% originally the mean averages the average capacity factor variances for all clusters
% by resource

NE_1_mre = mean(abs((NE_1_mat - NE_cred_mat)./NE_cred_mat));
NE_5_mre = mean(abs((NE_5_mat - NE_cred_mat)./NE_cred_mat));
NE_10_mre = mean(abs((NE_10_mat - NE_cred_mat)./NE_cred_mat));
NE_15_mre = mean(abs((NE_15_mat - NE_cred_mat)./NE_cred_mat));
NE_20_mre = mean(abs((NE_20_mat - NE_cred_mat)./NE_cred_mat));
NE_25_mre = mean(abs((NE_25_mat - NE_cred_mat)./NE_cred_mat));
NE_30_mre = mean(abs((NE_30_mat - NE_cred_mat)./NE_cred_mat));
NE_35_mre = mean(abs((NE_35_mat - NE_cred_mat)./NE_cred_mat));
NE_40_mre = mean(abs((NE_40_mat - NE_cred_mat)./NE_cred_mat));
NE_45_mre = mean(abs((NE_45_mat - NE_cred_mat)./NE_cred_mat));
NE_50_mre = mean(abs((NE_50_mat - NE_cred_mat)./NE_cred_mat));
NE_55_mre = mean(abs((NE_55_mat - NE_cred_mat)./NE_cred_mat));
NE_60_mre = mean(abs((NE_60_mat - NE_cred_mat)./NE_cred_mat));
NE_65_mre = mean(abs((NE_65_mat - NE_cred_mat)./NE_cred_mat));
NE_70_mre = mean(abs((NE_70_mat - NE_cred_mat)./NE_cred_mat));
NE_75_mre = mean(abs((NE_75_mat - NE_cred_mat)./NE_cred_mat));

NE_mre = [NE_1_mre;NE_5_mre;NE_10_mre; NE_15_mre;
    NE_20_mre; NE_25_mre; NE_30_mre; NE_35_mre;
    NE_40_mre; NE_45_mre; NE_50_mre; NE_55_mre;
    NE_60_mre; NE_65_mre; NE_70_mre; NE_75_mre];

NE_mre_on_wind = NE_mre(:,1:35);
NE_mre_PV = NE_mre(:,36:70);
NE_mre_off_wind = NE_mre(:,71);

NE_mre_on_wind_avg = mean(NE_mre_on_wind,2);
NE_mre_PV_avg = mean(NE_mre_PV,2);
NE_mre_off_wind_avg = mean(NE_mre_off_wind,2);

% ----- CA Mean relative error calculations ---

CA_1_mre = mean(abs((CA_1_mat - CA_cred_mat)./CA_cred_mat));
CA_5_mre = mean(abs((CA_5_mat - CA_cred_mat)./CA_cred_mat));
CA_10_mre = mean(abs((CA_10_mat - CA_cred_mat)./CA_cred_mat));
CA_15_mre = mean(abs((CA_15_mat - CA_cred_mat)./CA_cred_mat));
CA_20_mre = mean(abs((CA_20_mat - CA_cred_mat)./CA_cred_mat));
CA_25_mre = mean(abs((CA_25_mat - CA_cred_mat)./CA_cred_mat));
CA_30_mre = mean(abs((CA_30_mat - CA_cred_mat)./CA_cred_mat));
CA_35_mre = mean(abs((CA_35_mat - CA_cred_mat)./CA_cred_mat));
CA_40_mre = mean(abs((CA_40_mat - CA_cred_mat)./CA_cred_mat));
CA_45_mre = mean(abs((CA_45_mat - CA_cred_mat)./CA_cred_mat));
CA_50_mre = mean(abs((CA_50_mat - CA_cred_mat)./CA_cred_mat));
CA_55_mre = mean(abs((CA_55_mat - CA_cred_mat)./CA_cred_mat));
CA_60_mre = mean(abs((CA_60_mat - CA_cred_mat)./CA_cred_mat));
CA_65_mre = mean(abs((CA_65_mat - CA_cred_mat)./CA_cred_mat));
CA_70_mre = mean(abs((CA_70_mat - CA_cred_mat)./CA_cred_mat));
CA_75_mre = mean(abs((CA_75_mat - CA_cred_mat)./CA_cred_mat));

CA_mre = [CA_1_mre;CA_5_mre;CA_10_mre; CA_15_mre;
    CA_20_mre; CA_25_mre; CA_30_mre; CA_35_mre;
    CA_40_mre; CA_45_mre; CA_50_mre; CA_55_mre;
    CA_60_mre; CA_65_mre; CA_70_mre; CA_75_mre];

CA_mre_on_wind = CA_mre(:,1:5);
CA_mre_PV = CA_mre(:,6:10);
CA_mre_off_wind = CA_mre(:,11);

CA_mre_on_wind_avg = mean(CA_mre_on_wind,2);
CA_mre_PV_avg = mean(CA_mre_PV,2);
CA_mre_off_wind_avg = mean(CA_mre_off_wind,2);

% ----- NW Mean relative error calculations ---

NW_1_mre = mean(abs((NW_1_mat - NW_cred_mat)./NW_cred_mat));
NW_5_mre = mean(abs((NW_5_mat - NW_cred_mat)./NW_cred_mat));
NW_10_mre = mean(abs((NW_10_mat - NW_cred_mat)./NW_cred_mat));
NW_15_mre = mean(abs((NW_15_mat - NW_cred_mat)./NW_cred_mat));
NW_20_mre = mean(abs((NW_20_mat - NW_cred_mat)./NW_cred_mat));
NW_25_mre = mean(abs((NW_25_mat - NW_cred_mat)./NW_cred_mat));
NW_30_mre = mean(abs((NW_30_mat - NW_cred_mat)./NW_cred_mat));
NW_35_mre = mean(abs((NW_35_mat - NW_cred_mat)./NW_cred_mat));
NW_40_mre = mean(abs((NW_40_mat - NW_cred_mat)./NW_cred_mat));
NW_45_mre = mean(abs((NW_45_mat - NW_cred_mat)./NW_cred_mat));
NW_50_mre = mean(abs((NW_50_mat - NW_cred_mat)./NW_cred_mat));
NW_55_mre = mean(abs((NW_55_mat - NW_cred_mat)./NW_cred_mat));
NW_60_mre = mean(abs((NW_60_mat - NW_cred_mat)./NW_cred_mat));
NW_65_mre = mean(abs((NW_65_mat - NW_cred_mat)./NW_cred_mat));
NW_70_mre = mean(abs((NW_70_mat - NW_cred_mat)./NW_cred_mat));
NW_75_mre = mean(abs((NW_75_mat - NW_cred_mat)./NW_cred_mat));


NW_mre = [NW_1_mre;NW_5_mre;NW_10_mre; NW_15_mre;
    NW_20_mre; NW_25_mre; NW_30_mre; NW_35_mre;
    NW_40_mre; NW_45_mre; NW_50_mre; NW_55_mre;
    NW_60_mre; NW_65_mre; NW_70_mre; NW_75_mre];

NW_mre_on_wind = NW_mre(:,1:25);
NW_mre_PV = NW_mre(:,26:50);
NW_mre_off_wind = NW_mre(:,51);

NW_mre_on_wind_avg = mean(NW_mre_on_wind,2);
NW_mre_PV_avg = mean(NW_mre_PV,2);
NW_mre_off_wind_avg = mean(NW_mre_off_wind,2);

% ----- CEN Mean relative error calculations ---
CEN_1_mre = mean(abs((CEN_1_mat - CEN_cred_mat)./CEN_cred_mat));
CEN_5_mre = mean(abs((CEN_5_mat - CEN_cred_mat)./CEN_cred_mat));
CEN_10_mre = mean(abs((CEN_10_mat - CEN_cred_mat)./CEN_cred_mat));
CEN_15_mre = mean(abs((CEN_15_mat - CEN_cred_mat)./CEN_cred_mat));
CEN_20_mre = mean(abs((CEN_20_mat - CEN_cred_mat)./CEN_cred_mat));
CEN_25_mre = mean(abs((CEN_25_mat - CEN_cred_mat)./CEN_cred_mat));
CEN_30_mre = mean(abs((CEN_30_mat - CEN_cred_mat)./CEN_cred_mat));
CEN_35_mre = mean(abs((CEN_35_mat - CEN_cred_mat)./CEN_cred_mat));
CEN_40_mre = mean(abs((CEN_40_mat - CEN_cred_mat)./CEN_cred_mat));
CEN_45_mre = mean(abs((CEN_45_mat - CEN_cred_mat)./CEN_cred_mat));
CEN_50_mre = mean(abs((CEN_50_mat - CEN_cred_mat)./CEN_cred_mat));
CEN_55_mre = mean(abs((CEN_55_mat - CEN_cred_mat)./CEN_cred_mat));
CEN_60_mre = mean(abs((CEN_60_mat - CEN_cred_mat)./CEN_cred_mat));
CEN_65_mre = mean(abs((CEN_65_mat - CEN_cred_mat)./CEN_cred_mat));
CEN_70_mre = mean(abs((CEN_70_mat - CEN_cred_mat)./CEN_cred_mat));
CEN_75_mre = mean(abs((CEN_75_mat - CEN_cred_mat)./CEN_cred_mat));


CEN_mre = [CEN_1_mre;CEN_5_mre;CEN_10_mre; CEN_15_mre;
    CEN_20_mre; CEN_25_mre; CEN_30_mre; CEN_35_mre;
    CEN_40_mre; CEN_45_mre; CEN_50_mre; CEN_55_mre;
    CEN_60_mre; CEN_65_mre; CEN_70_mre; CEN_75_mre];

CEN_mre_on_wind = CEN_mre(:,1:35);
CEN_mre_PV = CEN_mre(:,36:70);

CEN_mre_on_wind_avg = mean(CEN_mre_on_wind,2);
CEN_mre_PV_avg = mean(CEN_mre_PV,2);

% ----- MID_AT Mean relative error calculations ---
MID_AT_1_mre = mean(abs((MID_AT_1_mat - MID_AT_cred_mat)./MID_AT_cred_mat));
MID_AT_5_mre = mean(abs((MID_AT_5_mat - MID_AT_cred_mat)./MID_AT_cred_mat));
MID_AT_10_mre = mean(abs((MID_AT_10_mat - MID_AT_cred_mat)./MID_AT_cred_mat));
MID_AT_15_mre = mean(abs((MID_AT_15_mat - MID_AT_cred_mat)./MID_AT_cred_mat));
MID_AT_20_mre = mean(abs((MID_AT_20_mat - MID_AT_cred_mat)./MID_AT_cred_mat));
MID_AT_25_mre = mean(abs((MID_AT_25_mat - MID_AT_cred_mat)./MID_AT_cred_mat));
MID_AT_30_mre = mean(abs((MID_AT_30_mat - MID_AT_cred_mat)./MID_AT_cred_mat));
MID_AT_35_mre = mean(abs((MID_AT_35_mat - MID_AT_cred_mat)./MID_AT_cred_mat));
MID_AT_40_mre = mean(abs((MID_AT_40_mat - MID_AT_cred_mat)./MID_AT_cred_mat));
MID_AT_45_mre = mean(abs((MID_AT_45_mat - MID_AT_cred_mat)./MID_AT_cred_mat));
MID_AT_50_mre = mean(abs((MID_AT_50_mat - MID_AT_cred_mat)./MID_AT_cred_mat));
MID_AT_55_mre = mean(abs((MID_AT_55_mat - MID_AT_cred_mat)./MID_AT_cred_mat));
MID_AT_60_mre = mean(abs((MID_AT_60_mat - MID_AT_cred_mat)./MID_AT_cred_mat));
MID_AT_65_mre = mean(abs((MID_AT_65_mat - MID_AT_cred_mat)./MID_AT_cred_mat));
MID_AT_70_mre = mean(abs((MID_AT_70_mat - MID_AT_cred_mat)./MID_AT_cred_mat));
MID_AT_75_mre = mean(abs((MID_AT_75_mat - MID_AT_cred_mat)./MID_AT_cred_mat));


MID_AT_mre = [MID_AT_1_mre;MID_AT_5_mre;MID_AT_10_mre; MID_AT_15_mre;
    MID_AT_20_mre; MID_AT_25_mre; MID_AT_30_mre; MID_AT_35_mre;
    MID_AT_40_mre; MID_AT_45_mre; MID_AT_50_mre; MID_AT_55_mre;
    MID_AT_60_mre; MID_AT_65_mre; MID_AT_70_mre; MID_AT_75_mre];

MID_AT_mre_on_wind = MID_AT_mre(:,1:35);
MID_AT_mre_PV = MID_AT_mre(:,36:70);

MID_AT_mre_on_wind_avg = mean(MID_AT_mre_on_wind,2);
MID_AT_mre_PV_avg = mean(MID_AT_mre_PV,2);


% ----- N_CEN Mean relative error calculations ---
N_CEN_1_mre = mean(abs((N_CEN_1_mat - N_CEN_cred_mat)./N_CEN_cred_mat));
N_CEN_5_mre = mean(abs((N_CEN_5_mat - N_CEN_cred_mat)./N_CEN_cred_mat));
N_CEN_10_mre = mean(abs((N_CEN_10_mat - N_CEN_cred_mat)./N_CEN_cred_mat));
N_CEN_15_mre = mean(abs((N_CEN_15_mat - N_CEN_cred_mat)./N_CEN_cred_mat));
N_CEN_20_mre = mean(abs((N_CEN_20_mat - N_CEN_cred_mat)./N_CEN_cred_mat));
N_CEN_25_mre = mean(abs((N_CEN_25_mat - N_CEN_cred_mat)./N_CEN_cred_mat));
N_CEN_30_mre = mean(abs((N_CEN_30_mat - N_CEN_cred_mat)./N_CEN_cred_mat));
N_CEN_35_mre = mean(abs((N_CEN_35_mat - N_CEN_cred_mat)./N_CEN_cred_mat));
N_CEN_40_mre = mean(abs((N_CEN_40_mat - N_CEN_cred_mat)./N_CEN_cred_mat));
N_CEN_45_mre = mean(abs((N_CEN_45_mat - N_CEN_cred_mat)./N_CEN_cred_mat));
N_CEN_50_mre = mean(abs((N_CEN_50_mat - N_CEN_cred_mat)./N_CEN_cred_mat));
N_CEN_55_mre = mean(abs((N_CEN_55_mat - N_CEN_cred_mat)./N_CEN_cred_mat));
N_CEN_60_mre = mean(abs((N_CEN_60_mat - N_CEN_cred_mat)./N_CEN_cred_mat));
N_CEN_65_mre = mean(abs((N_CEN_65_mat - N_CEN_cred_mat)./N_CEN_cred_mat));
N_CEN_70_mre = mean(abs((N_CEN_70_mat - N_CEN_cred_mat)./N_CEN_cred_mat));
N_CEN_75_mre = mean(abs((N_CEN_75_mat - N_CEN_cred_mat)./N_CEN_cred_mat));


N_CEN_mre = [N_CEN_1_mre;N_CEN_5_mre;N_CEN_10_mre; N_CEN_15_mre;
    N_CEN_20_mre; N_CEN_25_mre; N_CEN_30_mre; N_CEN_35_mre;
    N_CEN_40_mre; N_CEN_45_mre; N_CEN_50_mre; N_CEN_55_mre;
    N_CEN_60_mre; N_CEN_65_mre; N_CEN_70_mre; N_CEN_75_mre];

N_CEN_mre_on_wind = N_CEN_mre(:,1:35);
N_CEN_mre_PV = N_CEN_mre(:,36:70);

N_CEN_mre_on_wind_avg = mean(N_CEN_mre_on_wind,2);
N_CEN_mre_PV_avg = mean(N_CEN_mre_PV,2);

% ----- SE Mean relative error calculations ---
SE_1_mre = mean(abs((SE_1_mat - SE_cred_mat)./SE_cred_mat));
SE_5_mre = mean(abs((SE_5_mat - SE_cred_mat)./SE_cred_mat));
SE_10_mre = mean(abs((SE_10_mat - SE_cred_mat)./SE_cred_mat));
SE_15_mre = mean(abs((SE_15_mat - SE_cred_mat)./SE_cred_mat));
SE_20_mre = mean(abs((SE_20_mat - SE_cred_mat)./SE_cred_mat));
SE_25_mre = mean(abs((SE_25_mat - SE_cred_mat)./SE_cred_mat));
SE_30_mre = mean(abs((SE_30_mat - SE_cred_mat)./SE_cred_mat));
SE_35_mre = mean(abs((SE_35_mat - SE_cred_mat)./SE_cred_mat));
SE_40_mre = mean(abs((SE_40_mat - SE_cred_mat)./SE_cred_mat));
SE_45_mre = mean(abs((SE_45_mat - SE_cred_mat)./SE_cred_mat));
SE_50_mre = mean(abs((SE_50_mat - SE_cred_mat)./SE_cred_mat));
SE_55_mre = mean(abs((SE_55_mat - SE_cred_mat)./SE_cred_mat));
SE_60_mre = mean(abs((SE_60_mat - SE_cred_mat)./SE_cred_mat));
SE_65_mre = mean(abs((SE_65_mat - SE_cred_mat)./SE_cred_mat));
SE_70_mre = mean(abs((SE_70_mat - SE_cred_mat)./SE_cred_mat));
SE_75_mre = mean(abs((SE_75_mat - SE_cred_mat)./SE_cred_mat));


SE_mre = [SE_1_mre;SE_5_mre;SE_10_mre; SE_15_mre;
    SE_20_mre; SE_25_mre; SE_30_mre; SE_35_mre;
    SE_40_mre; SE_45_mre; SE_50_mre; SE_55_mre;
    SE_60_mre; SE_65_mre; SE_70_mre; SE_75_mre];

SE_mre_on_wind = SE_mre(:,1:40);
SE_mre_PV = SE_mre(:,41:80);

SE_mre_on_wind_avg = mean(SE_mre_on_wind,2);
SE_mre_PV_avg = mean(SE_mre_PV,2);


% ----- SW Mean relative error calculations ---
SW_1_mre = mean(abs((SW_1_mat - SW_cred_mat)./SW_cred_mat));
SW_5_mre = mean(abs((SW_5_mat - SW_cred_mat)./SW_cred_mat));
SW_10_mre = mean(abs((SW_10_mat - SW_cred_mat)./SW_cred_mat));
SW_15_mre = mean(abs((SW_15_mat - SW_cred_mat)./SW_cred_mat));
SW_20_mre = mean(abs((SW_20_mat - SW_cred_mat)./SW_cred_mat));
SW_25_mre = mean(abs((SW_25_mat - SW_cred_mat)./SW_cred_mat));
SW_30_mre = mean(abs((SW_30_mat - SW_cred_mat)./SW_cred_mat));
SW_35_mre = mean(abs((SW_35_mat - SW_cred_mat)./SW_cred_mat));
SW_40_mre = mean(abs((SW_40_mat - SW_cred_mat)./SW_cred_mat));
SW_45_mre = mean(abs((SW_45_mat - SW_cred_mat)./SW_cred_mat));
SW_50_mre = mean(abs((SW_50_mat - SW_cred_mat)./SW_cred_mat));
SW_55_mre = mean(abs((SW_55_mat - SW_cred_mat)./SW_cred_mat));
SW_60_mre = mean(abs((SW_60_mat - SW_cred_mat)./SW_cred_mat));
SW_65_mre = mean(abs((SW_65_mat - SW_cred_mat)./SW_cred_mat));
SW_70_mre = mean(abs((SW_70_mat - SW_cred_mat)./SW_cred_mat));
SW_75_mre = mean(abs((SW_75_mat - SW_cred_mat)./SW_cred_mat));

SW_mre = [SW_1_mre;SW_5_mre;SW_10_mre; SW_15_mre;
    SW_20_mre; SW_25_mre; SW_30_mre; SW_35_mre;
    SW_40_mre; SW_45_mre; SW_50_mre; SW_55_mre;
    SW_60_mre; SW_65_mre; SW_70_mre; SW_75_mre];

SW_mre_on_wind = SW_mre(:,1:25);
SW_mre_PV = SW_mre(:,26:50);

SW_mre_on_wind_avg = mean(SW_mre_on_wind,2);
SW_mre_PV_avg = mean(SW_mre_PV,2);

% ----- TX Mean relative error calculations ---
TX_1_mre = mean(abs((TX_1_mat - TX_cred_mat)./TX_cred_mat));
TX_5_mre = mean(abs((TX_5_mat - TX_cred_mat)./TX_cred_mat));
TX_10_mre = mean(abs((TX_10_mat - TX_cred_mat)./TX_cred_mat));
TX_15_mre = mean(abs((TX_15_mat - TX_cred_mat)./TX_cred_mat));
TX_20_mre = mean(abs((TX_20_mat - TX_cred_mat)./TX_cred_mat));
TX_25_mre = mean(abs((TX_25_mat - TX_cred_mat)./TX_cred_mat));
TX_30_mre = mean(abs((TX_30_mat - TX_cred_mat)./TX_cred_mat));
TX_35_mre = mean(abs((TX_35_mat - TX_cred_mat)./TX_cred_mat));
TX_40_mre = mean(abs((TX_40_mat - TX_cred_mat)./TX_cred_mat));
TX_45_mre = mean(abs((TX_45_mat - TX_cred_mat)./TX_cred_mat));
TX_50_mre = mean(abs((TX_50_mat - TX_cred_mat)./TX_cred_mat));
TX_55_mre = mean(abs((TX_55_mat - TX_cred_mat)./TX_cred_mat));
TX_60_mre = mean(abs((TX_60_mat - TX_cred_mat)./TX_cred_mat));
TX_65_mre = mean(abs((TX_65_mat - TX_cred_mat)./TX_cred_mat));
TX_70_mre = mean(abs((TX_70_mat - TX_cred_mat)./TX_cred_mat));
TX_75_mre = mean(abs((TX_75_mat - TX_cred_mat)./TX_cred_mat));


TX_mre = [TX_1_mre;TX_5_mre;TX_10_mre; TX_15_mre;
    TX_20_mre; TX_25_mre; TX_30_mre; TX_35_mre;
    TX_40_mre; TX_45_mre; TX_50_mre; TX_55_mre;
    TX_60_mre; TX_65_mre; TX_70_mre; TX_75_mre];

TX_mre_on_wind = TX_mre(:,1:5);
TX_mre_PV = TX_mre(:,6:10);

TX_mre_on_wind_avg = mean(TX_mre_on_wind,2);
TX_mre_PV_avg = mean(TX_mre_PV,2);
...
nexttile
plot(x,NW_mre_on_wind*100,'.-','MarkerSize',20, 'color', '#d6ffff')
hold on
plot(x,median(NW_mre_on_wind*100,2),'.-','MarkerSize',20, 'color', '#0096FF') % median wind
hold on 
plot(x,NW_mre_PV*100,'.-','MarkerSize',20, 'color', '#ffff80') 
hold on
plot(x,median(NW_mre_PV*100,2),'.-','MarkerSize',20, 'color', '#FFBF00')% median PV
hold on
plot(x,NW_mre_off_wind*100,'.-','MarkerSize',20, 'color', '#000000','LineWidth',2)
axis([-5 80 0 ylimit])
...
nexttile
plot(x,N_CEN_mre_on_wind*100,'.-','MarkerSize',20, 'color', '#d6ffff')
hold on
plot(x,median(N_CEN_mre_on_wind*100,2),'.-','MarkerSize',20, 'color', '#0096FF') % median wind
hold on 
plot(x,N_CEN_mre_PV*100,'.-','MarkerSize',20, 'color', '#ffff80')
hold on
plot(x,median(N_CEN_mre_PV*100,2),'.-','MarkerSize',20, 'color', '#FFBF00')% median PV
axis([-5 80 0 ylimit])
...
nexttile
plot(x,NE_mre_on_wind*100,'.-','MarkerSize',20, 'color', '#d6ffff')
hold on
plot(x,median(NE_mre_on_wind*100,2),'.-','MarkerSize',20, 'color', '#0096FF') % median wind
hold on 
plot(x,NE_mre_PV*100,'.-','MarkerSize',20, 'color', '#ffff80')
hold on
plot(x,median(NE_mre_PV*100,2),'.-','MarkerSize',20, 'color', '#FFBF00')% median PV
hold on
plot(x,NE_mre_off_wind*100,'.-','MarkerSize',20, 'color', '#000000','LineWidth',2)
axis([-5 80 0 ylimit])
...
nexttile
plot(x,CA_mre_on_wind*100,'.-','MarkerSize',20, 'color', '#d6ffff')
hold on
plot(x,median(CA_mre_on_wind*100,2),'.-','MarkerSize',20, 'color', '#0096FF') % median wind
hold on 
plot(x,CA_mre_PV*100,'.-','MarkerSize',20, 'color', '#ffff80')
hold on
plot(x,median(CA_mre_PV*100,2),'.-','MarkerSize',20, 'color', '#FFBF00')% median PV
hold on
plot(x,CA_mre_off_wind*100,'.-','MarkerSize',20, 'color', '#000000','LineWidth',2)
axis([-5 80 0 ylimit])
set(gca,'xticklabel',[],'FontSize',15)
grid on
xticks([1,5:5:75])
...
nexttile
plot(x,CEN_mre_on_wind*100,'.-','MarkerSize',20, 'color', '#d6ffff')
hold on
plot(x,median(CEN_mre_on_wind*100,2),'.-','MarkerSize',20, 'color', '#0096FF') % median wind
hold on 
plot(x,CEN_mre_PV*100,'.-','MarkerSize',20, 'color', '#ffff80')
hold on
plot(x,median(CEN_mre_PV*100,2),'.-','MarkerSize',20, 'color', '#FFBF00')% median PV
axis([-5 80 0 ylimit])
set(gca,'xticklabel',[], 'yticklabel', [])
grid on
xticks([1,5:5:75])
...
nexttile
plot(x,MID_AT_mre_on_wind*100,'.-','MarkerSize',20, 'color', '#d6ffff')
hold on
plot(x,median(MID_AT_mre_on_wind*100,2),'.-','MarkerSize',20, 'color', '#0096FF') % median wind
hold on 
plot(x,MID_AT_mre_PV*100,'.-','MarkerSize',20, 'color', '#ffff80')
hold on
plot(x,median(MID_AT_mre_PV*100,2),'.-','MarkerSize',20, 'color', '#FFBF00')% median PV
axis([-5 80 0 ylimit])
set(gca,'xticklabel',[], 'yticklabel', [])
grid on
xticks([1,5:5:75])
...
nexttile
plot(x,SW_mre_on_wind*100,'.-','MarkerSize',20, 'color', '#d6ffff')
hold on
plot(x,median(SW_mre_on_wind*100,2),'.-','MarkerSize',20, 'color', '#0096FF') % median wind
hold on 
plot(x,SW_mre_PV*100,'.-','MarkerSize',20, 'color', '#ffff80')
hold on
plot(x,median(SW_mre_PV*100,2),'.-','MarkerSize',20, 'color', '#FFBF00')% median PV
axis([-5 80 0 ylimit])
set(gca,'FontSize',15)
grid on
xticks([1,5:5:75])
...
nexttile
plot(x,TX_mre_on_wind*100,'.-','MarkerSize',20, 'color', '#d6ffff')
hold on
plot(x,median(TX_mre_on_wind*100,2),'.-','MarkerSize',20, 'color', '#0096FF') % median wind
hold on 
plot(x,TX_mre_PV*100,'.-','MarkerSize',20, 'color', '#ffff80')
hold on
plot(x,median(TX_mre_PV*100,2),'.-','MarkerSize',20, 'color', '#FFBF00')% median PV
axis([-5 80 0 ylimit])
...
nexttile
plot(x,SE_mre_on_wind*100,'.-','MarkerSize',20, 'color', '#d6ffff')
hold on
plot(x,median(SE_mre_on_wind*100,2),'.-','MarkerSize',20, 'color', '#0096FF') % median wind
hold on 
plot(x,SE_mre_PV*100,'.-','MarkerSize',20, 'color', '#ffff80')
hold on
plot(x,median(SE_mre_PV*100,2),'.-','MarkerSize',20, 'color', '#FFBF00')% median PV
axis([-5 80 0 ylimit])
set(gca,'yticklabel', [],'FontSize',15)
grid on
xticks([1,5:5:75])
...
title(t,'Mean Relative Error of Regional Average Capacity Factors vs. Hour Curve fit', 'FontSize', 24)
xlabel(t,'Number of top net load hours used','FontSize',20)
ylabel(t,'Mean Relative Error from Capacity Credit (%)','FontSize',20)
end
% plot operation
